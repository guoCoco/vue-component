<template>
  <div class="picker-slot" :class="classNames" :style="flexStyle">
    <div v-if="!divider" ref="wrapper" class="picker-slot-wrapper" :class="{ dragging: dragging }" :style="{ height: contentHeight/75 + 'rem' }">
      ...
      <div class="picker-item" v-for="(itemValue, index) in mutatingValues" :class="{ 'picker-selected': itemValue === currentValue, 'picker-first': mutatingValues[index + 2] === currentValue, 'picker-last': mutatingValues[index - 2] === currentValue}" :style="{ height: itemHeight/75 + 'rem', lineHeight: itemHeight/75 + 'rem' }">
...
<style>
  ...
  .picker-item.picker-first {
    color: #bbbbbb;
  }

  .picker-item.picker-last {
    color: #bbbbbb;
  }
