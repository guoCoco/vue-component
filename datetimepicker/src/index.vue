<template>
  <div class="bg-color" v-show="visible">
    <transition name='slide-bottom'>
      <div v-show='visible' class="Y-datetime">
        <y-picker
          :slots="dateSlots"
          @change="onChange"
          ...
          ref="picker"
          show-toolbar>
          <span class="action cancel" @click="visible = false">{{ cancelText }}</span>
...
<script type="text/babel">
  import yPicker from '../../picker/src/picker'
